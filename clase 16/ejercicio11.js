...
let list = ['Lucía', 'Ana', 'María', 'Luis', 'José', 'Pablo'];

let nameLength = list.filter(function(name){
    return name.length < 5
});
nameLength = nameLength.join(", ")
nameLength.toUpperCase();
console.log(`Los nombres seleccionados son ${nameLength}`);